...
INSTALLED_APPS = [
    ...
    'allauth.socialaccount.providers.yandex',  # Yandex provider
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'eaglet12iq@gmail.com'  # Ваш email
EMAIL_HOST_PASSWORD = 'oepg akwc tsak ketl'  # Пароль от почты
